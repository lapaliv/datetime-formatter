...
export class DateTimeFormatter {
  ...
  startOfMillisecond(): DateTimeFormatter {
    this.microseconds -= this.microseconds % Math.pow(10, 3);
    return this;
  }
  ...
  endOfMillisecond(): DateTimeFormatter {
    this.microseconds = 999000 + this.microseconds % Math.pow(10, 3);
    return this;
  }
  ...
  getIndexOfMicrosecondPeriodOnWhichDateIsIncluded(startedFrom: DateTimeFormatter, ...microseconds: Array<number> | Array<Array<number>>): number {
    return getIndexOfPeriodOnWhichDateIsIncluded(
      this.diffInMicroseconds(startedFrom),
      microseconds
    );
  }
  ...
  getIndexOfMillisecondPeriodOnWhichDateIsIncluded(startedFrom: DateTimeFormatter, ...milliseconds: Array<number> | Array<Array<number>>): number {
    return getIndexOfPeriodOnWhichDateIsIncluded(
      this.clone()
        .startOfMillisecond()
        .diffInMilliseconds(
          startedFrom.clone().startOfMillisecond()
        ),
      milliseconds
    );
  }
  ...
  getIndexOfSecondPeriodOnWhichDateIsIncluded(startedFrom: DateTimeFormatter, ...seconds: Array<number> | Array<Array<number>>): number {
    return getIndexOfPeriodOnWhichDateIsIncluded(
      this.clone()
        .startOfSecond()
        .diffInSeconds(
          startedFrom.clone().startOfSecond()
        ),
      seconds
    );
  }
  ...
  getIndexOfMinutePeriodOnWhichDateIsIncluded(startedFrom: DateTimeFormatter, ...minutes: Array<number> | Array<Array<number>>): number {
    return getIndexOfPeriodOnWhichDateIsIncluded(
      this.clone()
        .startOfMinute()
        .diffInMinutes(
          startedFrom.clone().startOfMinute()
        ),
      minutes
    );
  }
  ...
  getIndexOfMonthPeriodOnWhichDateIsIncluded(startedFrom: DateTimeFormatter, ...months: Array<number> | Array<Array<number>>): number {
    return getIndexOfPeriodOnWhichDateIsIncluded(
      this.clone()
        .startOfMonth()
        .diffInMonths(
          startedFrom.clone().startOfMonth()
        ),
      months
    );
  }
  ...
  getIndexOfDecadePeriodOnWhichDateIsIncluded(startedFrom: DateTimeFormatter, ...decades: Array<number> | Array<Array<number>>): number {
    return getIndexOfPeriodOnWhichDateIsIncluded(
      this.clone()
        .startOfDecade()
        .diffInDecades(
          startedFrom.clone().startOfDecade()
        ),
      decades
    );
  }
  ...
  getIndexOfCenturyPeriodOnWhichDateIsIncluded(startedFrom: DateTimeFormatter, ...centuries: Array<number> | Array<Array<number>>): number {
    return getIndexOfPeriodOnWhichDateIsIncluded(
      this.clone()
        .startOfCentury()
        .diffInCenturies(
          startedFrom.clone().startOfCentury()
        ),
      centuries
    );
  }
   ...
   */
  public getPreciseTimestamp(precision: number = 6): number {
    if (precision > 6) {
      throw new Error(`The precision may not be greater than 6.`);
    }

    if (precision < 0) {
      throw new Error(`The precision must be at least :min.`);
    }

    return Math.floor((this.toTimestamp() * Math.pow(10, 6) + this.microseconds) / Math.pow(10, 6 - precision));
  }
   ...
   * @param date
   */
  public greaterThan(date: DateTimeFormatter): boolean {
    return this.getPreciseTimestamp() > date.getPreciseTimestamp();
  }
   ...
   * @param date
   */
  public greaterThanOrEqualTo(date: DateTimeFormatter): boolean {
    return this.getPreciseTimestamp() >= date.getPreciseTimestamp();
  }
   ...
   * @param date
   */
  public lessThan(date: DateTimeFormatter): boolean {
    return this.getPreciseTimestamp() < date.getPreciseTimestamp();
  }
   ...
   * @param date
   */
  public lessThanOrEqualTo(date: DateTimeFormatter): boolean {
    return this.getPreciseTimestamp() <= date.getPreciseTimestamp();
  }
